import { Box, Stack, Heading, Paragraph } from "bumbag";
...
const TosPage: React.FC = () => {
  return (
    ...
    >
      ...
      <Stack spacing="major-3" marginBottom="40px">
        <Paragraph>
          This website is operated by Gibbs Photography, LLC. Throughout the site, the terms “we”,
          “us” and “our” refer to Gibbs Photography, LLC. Gibbs Photography, LLC offers this
        ...
        <Paragraph>Prices for our products are subject to change without notice.</Paragraph>
        <Paragraph>
        ...
        <Paragraph>For more detail, please review our Returns Policy. </Paragraph>
        <Heading use="h5" marginTop="major-4" marginBottom="major-2">
        ...
        <Paragraph>
          ...
          that will affect the functionality or operation of the Service or of any related website,
          other websites, or the Internet; (h) to collect or track the personal information of
          others; (i) to spam, phish, pharm, pretext, spider, crawl, or scrape; (j) for any obscene
          or immoral purpose; or (k) to interfere with or circumvent the security features of the
          Service or any related website, other websites, or the Internet. We reserve the right to
        ...
        <Paragraph>
          In no case shall Gibbs Photography, LLC, our directors, officers, employees, affiliates,
          agents, contractors, interns, suppliers, service providers or licensors be liable for any
          ...
          from your use of any of the service or any products procured using the service, or for any
          other claim related in any way to your use of the service or any product, including, but
        ...
        <Paragraph>
          You agree to indemnify, defend and hold harmless Gibbs Photography, LLC and our parent,
        ...
        <Paragraph>
          ...
          be governed by and construed in accordance with the laws of 474 Windingbrook Dr., Oshkosh,
          WI, 54904, United States.
        </Paragraph>
        <Heading use="h5" marginTop="major-4" marginBottom="major-2">
        ...
        <Paragraph>
          Questions about the Terms of Service should be sent to us at info@gibbs-photography.com.
        </Paragraph>
      </Stack>
    </Box>
  );
